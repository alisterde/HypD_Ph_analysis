...
class newtonRaphsonCap():
    ...
    def solve(self, times):
        ...
        print('dropping zero time')
        t = times[1:]
        # non dimensioanless times
        print('non dimensioning time')
        t=t/self.T0
        print('finished non dimensioning time')
        # specifying initial value of the current
        print('setting inital current')
        self.i[0] = self.I_inital/self.I0 # this is passed in dimensional
        index = 1
        for time in t:
            #print('find_epsilon')
            ...
            #print('completed_analytical_current_solution')
            index = index + 1
...
class wrappedNewtonCap(pints.ForwardModel):
    ...
    def _simulate(self, parameters, times, reduce):
        ...
        print('set_capacitance_params')
        solver.set_capacitance_params(parameters)
        print('capacitance_params set')
